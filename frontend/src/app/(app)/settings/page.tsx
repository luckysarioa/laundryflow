...
// ==========================================================
// Pengaturan / Akun — info pengguna & menu admin.
// ==========================================================
        ...
        {isPemilik && (
          <Card>
            ...
            <MenuItem
              ...
              label="Pengaturan Sistem" onClick={() => router.push("/system-settings")}
            />
            ...
            <MenuItem
              ...
              label="Kelola Plan" onClick={() => router.push("/plans")}
            />
            ...
            <MenuItem
              ...
              label="Laba/Rugi" onClick={() => router.push("/profit-loss")}
            />
            ...
            <MenuItem
              ...
              label="Backup & Restore" onClick={() => router.push("/backups")}
            />
          </Card>
        )}
